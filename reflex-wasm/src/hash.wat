...
(module
  ...
  (global $Hash::seed i32 (i32.const 2166136261))
  (global $Hash::prime i32 (i32.const 16777619))

  (func $Hash::new (result i32)
    (global.get $Hash::seed))

  (func $Hash::write_byte (param $self i32) (param $value i32) (result i32)
    (i32.mul (global.get $Hash::prime) (i32.xor (local.get $self) (local.get $value))))
  ...
  (func $Hash::write_term (param $self i32) (param $value i32) (result i32)
    (local.get $self)
