      ...
      (func $Stdlib_Remainder::impl::Int::Int (param $self i32) (param $divisor i32) (param $state i32) (result i32 i32)
        ...
        (if (result i32 i32)
          ...
          (then
            ...
            (global.get $NULL))
          (else
            (call $Int::new (i32.rem_s (call $Int::get::value (local.get $self)) (local.get $divisor_value)))
            (global.get $NULL)))))
      ...
      (func $Stdlib_Remainder::impl::Float::Int (param $self i32) (param $divisor i32) (param $state i32) (result i32 i32)
        ...
        (if (result i32 i32)
          ...
          (else
            (call $Float::new
              (if (result f64)
                (call $Utils::f64::is_integer (local.tee $self_value (call $Float::get::value (local.get $self))))
                (then
