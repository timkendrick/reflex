...
(module
  ...
  (global $Stdlib_CollectHashset (export "Stdlib_CollectHashset") i32 (i32.const 9))
  (global $Stdlib_CollectList (export "Stdlib_CollectList") i32 (i32.const 10))
  (global $Stdlib_CollectString (export "Stdlib_CollectString") i32 (i32.const 11))
  (global $Stdlib_CollectTree (export "Stdlib_CollectTree") i32 (i32.const 12))
  (global $Stdlib_Cons (export "Stdlib_Cons") i32 (i32.const 13))
  (global $Stdlib_Divide (export "Stdlib_Divide") i32 (i32.const 14))
  (global $Stdlib_Effect (export "Stdlib_Effect") i32 (i32.const 15))
  (global $Stdlib_EndsWith (export "Stdlib_EndsWith") i32 (i32.const 16))
  (global $Stdlib_Eq (export "Stdlib_Eq") i32 (i32.const 17))
  (global $Stdlib_Equal (export "Stdlib_Equal") i32 (i32.const 18))
  (global $Stdlib_Floor (export "Stdlib_Floor") i32 (i32.const 19))
  (global $Stdlib_Fold (export "Stdlib_Fold") i32 (i32.const 20))
  (global $Stdlib_Get (export "Stdlib_Get") i32 (i32.const 21))
  (global $Stdlib_Gt (export "Stdlib_Gt") i32 (i32.const 22))
  (global $Stdlib_Gte (export "Stdlib_Gte") i32 (i32.const 23))
  (global $Stdlib_Has (export "Stdlib_Has") i32 (i32.const 24))
  (global $Stdlib_Hash (export "Stdlib_Hash") i32 (i32.const 25))
  (global $Stdlib_Identity (export "Stdlib_Identity") i32 (i32.const 26))
  (global $Stdlib_If (export "Stdlib_If") i32 (i32.const 27))
  (global $Stdlib_IfError (export "Stdlib_IfError") i32 (i32.const 28))
  (global $Stdlib_IfPending (export "Stdlib_IfPending") i32 (i32.const 29))
  (global $Stdlib_Iterate (export "Stdlib_Iterate") i32 (i32.const 30))
  (global $Stdlib_Keys (export "Stdlib_Keys") i32 (i32.const 31))
  (global $Stdlib_Length (export "Stdlib_Length") i32 (i32.const 32))
  (global $Stdlib_Lt (export "Stdlib_Lt") i32 (i32.const 33))
  (global $Stdlib_Lte (export "Stdlib_Lte") i32 (i32.const 34))
  (global $Stdlib_Max (export "Stdlib_Max") i32 (i32.const 35))
  (global $Stdlib_Min (export "Stdlib_Min") i32 (i32.const 36))
  (global $Stdlib_Multiply (export "Stdlib_Multiply") i32 (i32.const 37))
  (global $Stdlib_Not (export "Stdlib_Not") i32 (i32.const 38))
  (global $Stdlib_Or (export "Stdlib_Or") i32 (i32.const 39))
  ...
  (global $Stdlib_ParseJson (export "Stdlib_ParseJson") i32 (i32.const 58))
  (global $Stdlib_StringifyJson (export "Stdlib_StringifyJson") i32 (i32.const 59))
  (global $Stdlib_ResolveQueryBranch (export "Stdlib_ResolveQueryBranch") i32 (i32.const 60))
  (global $Stdlib_ResolveQueryLeaf (export "Stdlib_ResolveQueryLeaf") i32 (i32.const 61))


  ;; Declare builtin function implementations
  (table (export "__indirect_function_table") 62 funcref)
  (elem (i32.const 0)
    $Stdlib_Abs
    $Stdlib_Add
    $Stdlib_And
