...
(module
  ...
  (func $Term::RepeatIterator::traits::debug (param $self i32) (param $offset i32) (result i32)
    (call $Term::RepeatIterator::traits::display (local.get $self) (local.get $offset)))
